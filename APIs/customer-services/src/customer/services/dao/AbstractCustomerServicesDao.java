...
public abstract class AbstractCustomerServicesDao {
	...
	public static final String PUSH_WISHLIST    = "update wishlists set wishlist = CONCAT(wishlist, ?) where username = ?";
	public static final String UPDATE_WISHLIST  = "update wishlists set wishlist = ? where username = ?";
