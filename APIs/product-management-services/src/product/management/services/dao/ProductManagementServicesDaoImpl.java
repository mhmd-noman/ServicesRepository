...
public class ProductManagementServicesDaoImpl extends AbstractProductManagementServicesDao {
	...
	@Override
	public List<Product> getProducts(ProductManagementRequest productsManagementRequest, Connection connection) {
	...
	private static List<Product> prepareProductsData(List<Map<Integer, Object>> productsResultSet) {
	...
	@Override
	public void addProduct(ProductManagementRequest productsManagementRequest, Connection connection) {
		List<Object> paramList = null;
	...
	@Override
	public void updateProduct(ProductManagementRequest productsManagementRequest, Connection connection) {
		List<Object> paramList = null;
		StringBuilder query = null;
