...
public abstract class AbstractTransactionLoggingServiceHandler {
	...
	public abstract TransactionLoggingResponse transLoggingManagementService(TransactionLoggingRequest transLoggingManagementRequest,  Connection connection);
}